...
class TermsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // type에 따라 데이터 선택
    final List<Map<String, String>> contentList = (type == 'privacy')
        ? privacyPolicy
        : termsOfService;

    // 앱바 타이틀 설정
    final String appBarTitle = (type == 'privacy') ? '개인정보 처리방침' : '서비스 이용약관';
...
final List<Map<String, String>> termsOfService = [
  ...
  {
    'type': 'body',
    'content': '2. 회사는 서비스의 일부 또는 전부를 운영상·기술상 필요에 따라 변경·중단할 수 있으며, 사전 공지합니다.',
  },
  {'type': 'space', 'content': ''},
  ...
  {
    'type': 'body',
    'content': '1. 회원가입 시 이용자는 정확한 정보 제공에 동의해야 하며, 변경 시 즉시 수정해야 합니다.',
  },
  {
    'type': 'body',
    'content':
  ...
  {
    'type': 'body',
    'content': '1. 본 서비스는 GPS·센서 등을 이용하여 이동 경로(위치정보)를 자동으로 수집·처리합니다.',
  },
  {
    'type': 'body',
    'content':
  ...
  {
    'type': 'body',
    'content': '3. 위치정보의 실시간 전송·공개 기능은 사용자가 별도 설정으로 허용한 경우에만 적용됩니다.',
  },
  {'type': 'space', 'content': ''},
  ...
  {
    'type': 'body',
    'content': '2. 불법·유해한 목적, 범죄 행위, 타인 비방·명예훼손, 개인정보 무단수집·게시 등을 금지합니다.',
  },
  {'type': 'space', 'content': ''},
  ...
  {
    'type': 'body',
    'content': '1. 이용자가 서비스에 업로드한 경로·사진·댓글 등의 게시물(이하 “게시물”)의 저작권은 게시자에게 있습니다.',
  },
  {
    'type': 'body',
    'content':
  ...
  {
    'type': 'body',
    'content': '3. 회사는 게시물이 타인의 권리를 침해한다고 판단되는 경우 사전통지 없이 삭제·이용제한 할 수 있습니다.',
  },
  {'type': 'space', 'content': ''},
  ...
  {
    'type': 'body',
    'content': '2. 이용자가 공유한 공개 경로를 통해 발생한 이용자 간 분쟁·피해는 해당 이용자 책임입니다.',
  },
  {'type': 'space', 'content': ''},
  ...
  {
    'type': 'body',
    'content': '2. 회사는 약관 위반·부정 이용 등 최소한의 절차를 거쳐 이용제한·계정정지·삭제할 수 있습니다.',
  },
  {'type': 'space', 'content': ''},
  ...
  {'type': 'subtitle', 'content': '제13조 (아동 보호 및 안전 정책)'},
  {
    'type': 'body',
    'content':
        '1. 회사는 아동의 안전을 최우선으로 하며, 아동 성적 학대 및 착취(CSAE, Child Sexual Abuse and Exploitation)를 명시적으로 금지합니다.',
  },
  {
    'type': 'body',
    'content':
        '2. 이용자는 아동을 대상으로 한 불법적 행위나 콘텐츠(아동 성착취물, 성적 학대 표현물 등)를 업로드하거나 공유해서는 안 됩니다.',
  },
  {
    'type': 'body',
    'content': '3. 회사는 아동 보호와 관련된 법령 및 Google Play의 아동 안전 표준 정책을 준수합니다.',
  },
  {
    'type': 'body',
    'content':
        '4. 이용자가 아동 보호 정책을 위반한 경우, 회사는 즉시 콘텐츠 삭제, 계정 정지 또는 수사기관 신고 등의 조치를 취할 수 있습니다.',
  },
  {
    'type': 'body',
    'content':
        '5. 회사는 아동 안전 및 학대 예방을 위한 담당자를 지정하며, 이용자는 아래 연락처를 통해 관련 신고나 문의를 할 수 있습니다.',
  },
  {'type': 'space', 'content': ''},
];
...
final List<Map<String, String>> privacyPolicy = [
  ...
  {
    'type': 'body',
    'content': '1. 필수 수집 항목: 회원가입 시 이메일(또는 휴대전화), 비밀번호(암호화 저장), 닉네임(선택)',
  },
  {
    'type': 'body',
    'content':
  ...
  {
    'type': 'body',
    'content': '3. 선택 수집 항목: 프로필 사진, 활동 통계(평균 속도, 주행 거리 등), 업로드 사진·코멘트 등.',
  },
  {'type': 'space', 'content': ''},
  ...
  },
  {
    'type': 'body',
    'content':
        '서비스 품질 향상 및 이용자 편의를 위해 백그라운드에서도 위치정보가 수집될 수 있으며, 명시적 동의 및 단말기 권한 허용이 필요합니다.',
  },
  {'type': 'space', 'content': ''},
  ...
  {
    'type': 'body',
    'content': '• 백그라운드 위치정보 수집: 실시간 주행 기록 유지, 안전 알림, 이동 통계 제공 등',
  },
  ...
  {
    'type': 'body',
    'content': '• 위치정보(경로 데이터): 기본 보관 기간은 3년. 이용자가 삭제 요청 시 지체없이 삭제 처리합니다.',
  },
  ...
  {
    'type': 'body',
    'content': '2. 이용자는 언제든지 위치정보 수집·이용을 중단(앱 권한 해제)하거나, 저장된 경로를 삭제할 수 있습니다.',
  },
  {
    'type': 'body',
    'content':
        '3. 백그라운드 위치 수집은 서비스 지속 제공을 위해 사용되며, 최초 실행 시 별도의 동의 절차를 통해 허용됩니다. 사용자는 단말기 설정 또는 앱 내 설정을 통해 철회할 수 있습니다.',
  },
  {'type': 'space', 'content': ''},
  ...
  {
    'type': 'body',
    'content': '2. 단, 이용자가 공개설정한 경로 등 공개 콘텐츠는 타 이용자 또는 제휴 서비스에 노출될 수 있습니다.',
  },
  {
    'type': 'body',
    'content': '3. 법령에 따른 요청 또는 서비스 제공을 위해 필요한 경우에는 관련 법령에 따라 제공할 수 있습니다.',
  },
  {'type': 'space', 'content': ''},
  ...
  {
    'type': 'body',
    'content': '1. 회사는 만 14세 미만 아동의 개인정보를 법정대리인의 동의 없이 수집하거나 이용하지 않습니다.',
  },
  {
    'type': 'body',
    'content':
        '2. 아동 관련 콘텐츠 및 데이터는 아동의 안전을 침해하지 않는 범위 내에서만 처리되며, 모든 절차는 관련 법령 및 Google Play 아동 안전 표준 정책을 준수합니다.',
  },
  {
    'type': 'body',
    'content':
        '3. 아동의 개인정보가 포함된 불법 콘텐츠(예: 아동 성착취물, CSAM 등)는 즉시 삭제되며, 관련 기관에 신고될 수 있습니다.',
  },
